...
# Define paths
FASTQ_DIR="/users/aaljord/agordo/git/24CRG_ADEL_MANU_MYOBLAST_SPLICING/data/raw/tao_molbiotech"
OUTDIR="/users/aaljord/agordo/git/24CRG_ADEL_MANU_MYOBLAST_SPLICING/Kallisto"
INDEX_DIR="/users/aaljord/agordo/git/24CRG_ADEL_MANU_OOCYTE_SPLICING/Kallisto/index"

# Get the list of FASTQ files
FASTQ_FILES=($(ls "$FASTQ_DIR"/*_1.fastq.gz))
FASTQ_R1=${FASTQ_FILES[$((SLURM_ARRAY_TASK_ID-1))]}
FASTQ_R2=${FASTQ_R1/_1.fastq.gz/_2.fastq.gz}
SAMPLE_NAME=$(basename "$FASTQ_R1" _1.fastq.gz)
