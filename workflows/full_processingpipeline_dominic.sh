...
##############################
# Full Processing Pipeline CRG Adel Lab for the Dominic Frontiers Dataset
...
jid2=$(sbatch --dependency=afterok:$jid1 $PWD/scripts/bash/dominic_frontiers_2024/run_fastqc_dominic.sh | tr -cd '[:digit:].')
