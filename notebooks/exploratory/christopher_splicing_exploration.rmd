...
path <- paste0(getwd(),"/inclusion_tables/Christopher_Physioreports_INCLUSION_LEVELS_FULL-mm10.tab")
...
metadata_path <- paste0(getwd(),"/metadata/christopher_metadata.csv")
