...
write.csv(exon_combination_tab, 
          file = file.path(output_dir, paste0("exon_combination_table_", format(Sys.Date(), "%Y%m%d"), ".csv")),
          row.names = FALSE)
...
write.csv(intron_combination_tab, 
          file = file.path(output_dir, paste0("intron_combination_table_", format(Sys.Date(), "%Y%m%d"), ".csv")),
          row.names = FALSE)
```
...
write.csv(multgroups_tab_exons, 
          file = file.path(output_dir, paste0("exon_multgroup_tab", format(Sys.Date(), "%Y%m%d"), ".csv")),
          row.names = FALSE)
```
...
write.csv(multgroups_tab_introns, 
          file = file.path(output_dir, paste0("introns_multgroup_tab", format(Sys.Date(), "%Y%m%d"), ".csv")),
          row.names = FALSE)
```
