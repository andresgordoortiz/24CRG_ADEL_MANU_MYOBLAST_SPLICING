---
title: 'Splicing Exploration of the Lyu Dataset'
...
path <- paste0(getwd(),"/inclusion_tables/Lyu_Cells_INCLUSION_LEVELS_FULL-mm10.tab")
...
metadata_path <- paste0(getwd(),"/metadata/lyu_metadata.csv")
...
tdensities <- plotIndividualDensitiesList(eventID = "MmuEX0044363",
                                          npoints = 500,
                                          psitable = exons$PSI,
                                          qualtable = exons$Qual,
                                          groupList = groupList,
...
tdensities + theme_minimal() + ggtitle("MmuEX0044363")

```

```{r densities_per_event 2, fig.width=8, fig.height=4, warning=F}
eventID<-"MmuEX0044363"
